  ...
  <table class="compare-info">
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td class="reviews"><img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" />
    ...
    <tr>
      <td></td>
      <?php foreach ($products as $product) { ?>
      <td class="action"><input type="button" value="<?php echo $button_cart; ?>" onclick="boss_addToCart('<?php echo $product['product_id']; ?>');" class="btn btn-primary" /><a href="<?php echo $product['remove']; ?>"><img class="btooltip" data-toggle="tooltip" data-placement="bottom" data-original-title="<?php echo $button_remove; ?>" src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
      <?php } ?>
    </tr>
  </table>
  </div>
