...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="content">
    <p class="choose_search"><b><?php echo $entry_search; ?></b>
      ...
      <?php } else { ?>
      <input type="text" class="text" name="search" value="<?php echo $search; ?>" onclick="this.value = '';" onkeydown="this.style.color = '000000'" style="color: #999;" />
      <?php } ?> <br/><br/>
  ...
  <div class="buttons">
    <div class="left"><input type="button" value="<?php echo $button_search; ?>" id="button-search" class="btn btn-primary btn-continue" /></div>
  </div>
