...
<div id="content"><?php echo $content_top; ?>
  ...
  <form class="voucher" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <table class="form">
      <tr>
    ...
    <div class="buttons">
      <div class="left">
        ...
        </br></br></br><input type="submit" value="<?php echo $button_continue; ?>" class="btn btn-primary btn-continue" />
      </div>
    </div>
  </form>
