...
<div id="content"><?php echo $content_top; ?>
  ...
  <table class="list">
    ...
    <tbody>
      <?php if(!empty($profile['transactions'])){ foreach ($profile['transactions'] as $transaction) {
      ?>
      <tr>
  ...
  <div class="buttons">
    <div class="right">
        <?php if($cancel_link){ ?>
        <a href="<?php echo $cancel_link; ?>" class="btn btn-primary btn-upload" onclick="return confirmCancel();"><?php echo $button_cancel_profile; ?></a>
        <?php } ?>
        <a href="<?php echo $continue; ?>" class="btn btn-primary btn-continue"><?php echo $button_continue; ?></a>
    </div>
  </div>
