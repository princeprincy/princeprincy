...
class ControllerModuleBossQuickshop extends Controller {
	...
	public function install() 
	{
		...
		0 => array ( 'array_class_selected' =>  ".product-list&gt;div, .product-grid&gt;div", 'text' => $array_description0, 'width' => 1000, 'height' => 800, 'layout_id' => $this->getIdLayout("category"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0),
		1 => array ( 'array_class_selected' =>  ".product-list&gt;div, .product-grid&gt;div", 'text' => $array_description0, 'width' => 1000, 'height' => 800,'layout_id' => $this->getIdLayout("manufacturer"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0),
		2 => array ( 'array_class_selected' =>  ".box-product&gt;li,.item&gt;div,.product-grid&gt;div&gt;div,.product-list&gt;div&gt;div", 'text' => $array_description0, 'width' => 1000, 'height' => 800,'layout_id' => $this->getIdLayout("product"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0),
		3 => array ( 'array_class_selected' =>  ".box-items &gt;.product-block, .box-item &gt;.product-block, .home_filter_content ul li", 'text' => $array_description0, 'width' => 1000, 'height' => 800,'layout_id' => $this->getIdLayout("home"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0)
		));
