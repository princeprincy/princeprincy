...
class ControllerModuleBossCategory extends Controller {
	...
	public function install() 
	{
		...
		$boss_category = array('boss_category_module' => array (
			0 => array('layout_id' => $this->getIdLayout("category"), 'position' => 'column_left','column' => 1, 'width' => 190, 'status' => 1, 'sort_order' => 1),
			1 => array('layout_id' => $this->getIdLayout("manufacturer"), 'position' => 'column_left','column' => 1, 'width' => 190, 'status' => 1, 'sort_order' => 1))
		);
