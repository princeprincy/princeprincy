...
class ControllerModuleBossMegamenu extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')  && !empty($this->request->post) ) {
				...
				$this->model_setting_setting->editSetting('boss_megamenu', $data);	
	...
	public function install() {
		...
		$boss_megamenu = array('boss_megamenu_module' => array ( 
			0 => array ('menu_width' => 1080,'store_id'=>array(0=>0), 'num_column' => 6, 'layout_id' => 9999, 'position' => 'mainmenu', 'status' => 1, 'sort_order' => 1))
		);
