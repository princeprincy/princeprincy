...
class ControllerModuleNewslettersubscribe extends Controller {
	...
	public function index() {   
		...
		$this->data['layouts'][] = array('layout_id'=>9999, 'name' => $this->language->get('text_all') );
	...
	public function install() {  
		...
		$newslettersubscribe = array(
			...
			'newslettersubscribe_registered' => 0,
			'newslettersubscribe_option_field' => 0,
			'newslettersubscribe_module' => array ( 
			0 => array ('layout_id' => 9999, 'position' => 'footer', 'status' => 1, 'sort_order' => 2)
			)
		);
		
		$this->model_setting_setting->editSetting('newslettersubscribe', $newslettersubscribe);		
	}
}
?>