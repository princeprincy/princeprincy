...
class ControllerModuleBossFeatured extends Controller {
	...
	public function install() {  
		...
		foreach($languages as $language){
			$array_description0{$language['language_id']} = "What's new";
		}
		$boss_featured = array('boss_featured_module' => array ( 
        0 => array ('title' => $array_description0, 'limit' => 24, 'item' => 8,'image_width' => 255,'image_height' => 255, 'layout_id' => $this->getIdLayout("home"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 4)
		));
