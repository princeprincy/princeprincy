...
function addModule() {	
	...
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><?php echo $text_limit; ?> &nbsp;<input type="text" name="boss_tagcloud_module[' + module_row + '][limit]" value="20" size="3" /></td>';
    ...
    html += '    </select></td>';
	html += '    <td class="left"><input type="text" name="boss_tagcloud_module[' + module_row + '][sort_order]" value="" size="6" /></td>';
