  ...
  <div class="box">
    ...
    <div class="content">
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<!-- CUSTOM BLOCK HEADER -->
			<div style="display:none;" id="BlockHeader" class="htabs-content">
				...
				<table cellpadding="0" cellspacing="0" width="100%" border="0">
					<tr>
						<td valign="top" >
							...
							<!-- CUSTOM FACEBOOK SETTING -->
							<div style="display:none;" id="tab_face_setting" class="vtabs-content">
								<div class="box" style="width:760px;">
									<div class="heading">
									...
									<div class="content">
										<table class="form">
											<tr>
												<td><h3>Facebook Status</h3></td>
												<td class="left">
													<select name="b_Footer_Face[status]">
														<?php if ($b_Footer_Face['status']) { ?>
															<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
															<option value="0"><?php echo $text_disabled; ?></option>
														<?php } else { ?>
															<option value="1"><?php echo $text_enabled; ?></option>
											...
											<tr>
												<td><h3>Facebook Title</h3></td>
												<td>
													<?php foreach ($languages as $language) { ?>
														<input name="b_Footer_Face[title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($b_Footer_Face['title'][$language['language_id']]) ? $b_Footer_Face['title'][$language['language_id']] : ''; ?>" />
														<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />
													<?php } ?>
												</td>
											</tr>
											<tr>
												<td><h3>Facebook Page ID:</h3></td>
												<td>
													<input name="b_Footer_Face[page_id]" value="<?php echo isset($b_Footer_Face['page_id']) ? $b_Footer_Face['page_id'] : ''; ?>" />
												</td>
											</tr>
										</table>
									</div>
